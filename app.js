...
const updatePage = async () => {
  ...
  const citrus = fruitsArray.filter((fruit) => fruit.genus == "Citrus")
  console.log(citrus)

  // TODO: Create a new HTML element to display your data 
  const newElt = document.createElement('div');
  newElt.innerHTML = "citrus fruits: " + JSON.stringify(citrus);

  // TODO: Append your new element to the page
  const existingElt = document.getElementById('cs1300-gallery');
  existingElt.append(newElt);
